                ...
                for kappa=1:1:10
                    try
                        ...
                        for block=3 %初始化獨立變數vars1, s1, s2, s3
                            ...
                            [prog, R1] = sospolymatrixvar(prog,monomials(vars,0),sizeA,'symmetric');            % 創建R1矩陣
                            ...
                            [prog, R2] = sospolymatrixvar(prog,monomials(vars,0),sizeA,'symmetric');            % 創建R2矩陣
                        ...
                        for block=4
                            ...
                            prog = sosmatrixineq(prog,SOS2);
                             % 在SOS程式加入矩陣不等式約束，其約束為R1-eps3矩陣不等式
                            %為定理穩定條件第三個
                            SOS2 = s2.'*(R1-eps3.*eye(sizeA))*s3;
                            prog = sosmatrixineq(prog,SOS3);
                            %N=1
                            ...
                            for subblock=1
                                ...
                                Oa111=diff(P1,x2).*(A1(3,:)*x_h)+H11+H11.'-Aij_tear*X1-X1.'*Aij_tear+Sum11;
                                Oa121=-H11+H21.'-Bij_tear*Mgse_tear-X1.'*Aij_tear.';
                                Oa131=P1+H31.'+X1-X1.'*Aij_tear;
                                Oa141=-Dij_tear;%(3*1)
                                Oa151=lambda*H11;
                                Oa161=(Cij_tear*X1).';%(3*2)
                                Oa171=-J_tear*X1;
                                Oa181=kappa*X1.'*Raij.';
                                %%
                                Oa211=Oa121.';
                            ...
                            for subblock=2
                                ...
                                Oa111=diff(P1,x2).*(A1(3,:)*x_h)+H11+H11.'-Aij_tear*X1-X1.'*Aij_tear+Sum21;
                                Oa121=-H11+H21.'-Bij_tear*Mgse_tear-X1.'*Aij_tear.';
                                Oa131=P1+H31.'+X1-X1.'*Aij_tear;
                                Oa141=-Dij_tear;%(3*1)
                                Oa151=lambda*H11;
                            ...
                            for subblock=3
                                ...
                                Ob111=diff(P1,x2).*(A1(3,:)*x_h)+H11+H11.'-Aij_tear*X1-X1.'*Aij_tear+Sum21;
                                Ob121=-H11+H21.'-Bij_tear*Mgse_tear-X1.'*Aij_tear.';
                                Ob131=P1+H31.'+X1-X1.'*Aij_tear;
                                Ob141=-Dij_tear;%(3*1)
                                Ob151=lambda*H11;
                                Ob161=(Cij_tear*X1).';%(3*2)
                                Ob171=-J_tear*X1;
                                Ob181=kappa*X1.'*Raij.';
                                ...
                                %2111結束
                                SOS5=s3.'*(-[O12221]-[O21111]-eps3.*eye(21))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=4
                                ...
                                %2211結束
                                SOS6=s3.'*(-[O11221]-[O22111]-eps3.*eye(21))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=5
                                ...
                                Ob111=diff(P1,x2).*(A1(3,:)*x_h)+H11+H11.'-Aij_tear*X1-X1.'*Aij_tear+Sum11;
                                Ob121=-H11+H21.'-Bij_tear*Mgse_tear-X1.'*Aij_tear.';
                                Ob131=P1+H31.'+X1-X1.'*Aij_tear;
                                Ob141=-Dij_tear;%(3*1)
                                Ob151=lambda*H11;
                                ...
                                %1211結束
                                SOS7=s3.'*(-[O21221]-[O12111]-eps3.*eye(21))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=6
                                ...
                                %2221結束
                                SOS8=s3.'*(-[O11121]-[O22211]-eps3.*eye(21))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=7
                                ...
                                %2121結束
                                SOS9=s3.'*(-[O12121]-[O21211]-eps3.*eye(21))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=8
                                ...
                                %1221結束
                                SOS10=s3.'*(-[O21121]-[O12211]-eps3.*eye(21))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=9
                                ...
                                %2211結束
                                SOS11=s3.'*(-[O22121]-[O11211]-eps3.*eye(21))*s3;
                                % 宣告不等式矩陣
                        ...
                        for block=7
                            if N==2
                                ...
                                for subblock=1
                                    ...
                                    Oa112=diff(P2,x2).*(A1(3,:)*x_h)+H12+H12.'-Aij_tear*X2-X2.'*Aij_tear+Sum12;
                                    Oa122=-H12+H22.'-Bij_tear*Mgse_tear-X2.'*Aij_tear.';
                                    Oa132=P2+H32.'+X2-X2.'*Aij_tear;
                                    Oa142=-Dij_tear;%(3*1)
                                    Oa152=lambda*H12;
                                    Oa162=(Cij_tear*X2).';%(3*2)
                                    Oa172=-J_tear*X2;
                                    Oa182=kappa*X2.'*Raij.';
                                    
                                    Oa212=Oa122.';
                                    Oa222=-H22-H22.'-Bij_tear*Mgse_tear-Mgse_tear.'*Bij_tear.';
                                    Oa232=-H32.'+X2-Mgse_tear.'*Bij_tear.';
                                    Oa242=-Dij_tear;
                                    Oa252=lambda*H22;
                                    Oa262=zeros(3,2);%(3*2)
                                    Oa272=-J_tear*X2;
                                    Oa282=kappa* Mgse_tear.'*Rbij.';
                                    
                                    Oa312=Oa132.';
                                    Oa322=Oa232.';
                                    Oa332=lambda*Q2+X2.'+X2;
                                    Oa342=-Dij_tear;%(3*1)
                                    Oa352=lambda*H32;
                                    Oa362=zeros(3,2);%(3*2)
                                    Oa372=-J_tear*X2;
                                    ...
                                    O11112=[Oa112  Oa122  Oa132  Oa142  Oa152  Oa162  Oa172  Oa182;
                                        Oa212  Oa222  Oa232  Oa242  Oa252  Oa262  Oa272  Oa282;
                                        Oa312  Oa322  Oa332  Oa342  Oa352  Oa362  Oa372  Oa382;
                                        Oa412  Oa422  Oa432  Oa442  Oa452  Oa462  Oa472  Oa482;
                                        Oa512  Oa522  Oa532  Oa542  Oa552  Oa562  Oa572  Oa582;
                                        Oa612  Oa622  Oa632  Oa642  Oa652  Oa662  Oa672  Oa682;
                                        Oa712  Oa722  Oa732  Oa742  Oa752  Oa762  Oa772  Oa782;
                                        Oa812  Oa822  Oa832  Oa842  Oa852  Oa862  Oa872  Oa882];
                                    
                                    SOS32=-s3.'*([O11111]+eps3.*eye(21))*s3;
                                    % 宣告不等式矩陣
                                    
                                    prog = sosineq(prog,SOS32,'sparsemultipartite',{ vars.' s3.'});
                                end
                                %22221
                                ...
                                for subblock=2
                                    ...
                                    Oa111=diff(P2,x2).*(A1(3,:)*x_h)+H12+H12.'-Aij_tear*X2-X2.'*Aij_tear+Sum22;
                                    Oa121=-H12+H22.'-Bij_tear*Mgse_tear-X2.'*Aij_tear.';
                                    Oa131=P2+H32.'+X2-X2.'*Aij_tear;
                                    Oa141=-Dij_tear;%(3*1)
                                    Oa151=lambda*H12;
                                    Oa161=(Cij_tear*X2).';%(3*2)
                                    Oa171=-J_tear*X2;
                                    Oa181=kappa*X2.'*Raij.';
                                ...
                                for subblock=3
                                    ...
                                    Oa111=diff(P2,x2).*(A1(3,:)*x_h)+H12+H12.'-Aij_tear*X2-X2.'*Aij_tear+Sum12;
                                    Oa121=-H12+H22.'-Bij_tear*Mgse_tear-X2.'*Aij_tear.';
                                    Oa131=P2+H32.'+X2-X2.'*Aij_tear;
                                    Oa141=-Dij_tear;%(3*1)
                                    Oa151=lambda*H12;
                                    ...
                                    Ob111=diff(P2,x2).*(A1(3,:)*x_h)+H12+H12.'-Aij_tear*X2-X2.'*Aij_tear+Sum22;
                                    Ob121=-H12+H22.'-Bij_tear*Mgse_tear-X2.'*Aij_tear.';
                                    Ob131=P2+H32.'+X2-X2.'*Aij_tear;
                                    Ob141=-Dij_tear;%(3*1)
                                    Ob151=lambda*H12;
                                    Ob161=(Cij_tear*X2).';%(3*2)
                                    Ob171=-J_tear*X2;
                                    Ob181=kappa*X2.'*Raij.';
                                ...
                                for subblock=5
                                    ...
                                    Ob111=diff(P2,x2).*(A1(3,:)*x_h)+H12+H12.'-Aij_tear*X2-X2.'*Aij_tear+Sum12;
                                    Ob121=-H12+H22.'-Bij_tear*Mgse_tear-X2.'*Aij_tear.';
                                    Ob131=P2+H32.'+X2-X2.'*Aij_tear;
                                    Ob141=-Dij_tear;%(3*1)
                                    Ob151=lambda*H12;
                        ...
                        for block=6
                            if N == 1
                                if M11(1,1)~=0 || M11(1,2)~=0 || M11(1,3)~=0 || M11(2,1)~=0 || M11(2,2)~=0 || M11(2,3)~=0
                                    if M21(1,1)~=0 || M21(1,2)~=0 || M21(1,3)~=0 || M21(2,1)~=0 || M21(2,2)~=0 || M21(2,3)~=0
                                        %用來記錄K的矩陣
                                        count_1 = count_1+1;
                                        %特徵值全正才是有解
                                        if eig_P1(1,1)>0 && eig_P1(2,1)>0 && eig_P1(3,1)>0 && eig_Q1(1,1)>0 
                                            && eig_Q1(2,1)>0 && eig_Q1(3,1)>0 eig_R1(1,1)>0 && eig_R1(2,1)>0 && eig_R-1(3,1)>0
                            ...
                            if N == 2
                                if M11(1,1)~=0 || M11(1,2)~=0 || M11(1,3)~=0 || M11(2,1)~=0 || M11(2,2)~=0 || M11(2,3)~=0
                                    if M21(1,1)~=0 || M21(1,2)~=0 || M21(1,3)~=0 || M21(2,1)~=0 || M21(2,2)~=0 || M21(2,3)~=0
                                        if M12(1,1)~=0 || M12(1,2)~=0 || M12(1,3)~=0 || M12(2,1)~=0 || M12(2,2)~=0 || M12(2,3)~=0
                                            if M22(1,1)~=0 || M22(1,2)~=0 || M22(1,3)~=0 || M22(2,1)~=0 || M22(2,2)~=0 || M22(2,3)~=0
                                                %用來記錄K的矩陣
                                                count_1 = count_1+1;
                                                %特徵值全正才是有解
                                                if eig_P1(1,1)>0 && eig_P1(2,1)>0 && eig_P1(3,1)>0 && eig_Q1(1,1)>0 && eig_Q1(2,1)>0 && eig_Q1(3,1)>0 eig_R1(1,1)>0 && eig_R1(2,1)>0 && eig_R1(3,1)>0
