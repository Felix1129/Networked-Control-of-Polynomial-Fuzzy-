                ...
                for kappa=1:1:10
                    try
                        ...
                        for block=1
                            ...
                            syms v11 v12 v13 v14
                            syms v21 v22 v23 v24 v25 v26 v27 v28 v29 v210 v211 v212 v213 v214
                            vars = [x1;x2];
                            s1=[v11;v12];
                            s2=[v13;v14];
                            %因為phi
                            s3=[v21; v22; v23; v24; v25; v26; v27; v28; v29; v210 ;v211 ;v212;v213;v214];
                            x_h=[x1;x2];
                            x=x_h;
                            % 宣告系統矩陣
                            A1 = [0  1 ;
                        ...
                        for block=4
                            ...
                            for subblock=1
                                ...
                                Oa111=diff(P1,x2).*(A1(2,:)*x_h)+H11+H11.'-Aij_tear*X1-X1.'*Aij_tear+Sum;
                            ...
                            for subblock=3
                                ...
                                Ob111=diff(P1,x2).*(A1(2,:)*x_h)+H11+H11.'-Aij_tear*X1-X1.'*Aij_tear+Sum;
                                ...
                                %2111結束
                                SOS5=s3.'*(-[O12221]-[O21111]-eps3.*eye(14))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=4
                                ...
                                %2211結束
                                SOS6=s3.'*(-[O11221]-[O22111]-eps3.*eye(14))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=5
                                ...
                                %1211結束
                                SOS7=s3.'*(-[O21221]-[O12111]-eps3.*eye(14))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=6
                                ...
                                %2221結束
                                SOS8=s3.'*(-[O11121]-[O22211]-eps3.*eye(14))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=7
                                ...
                                %2121結束
                                SOS9=s3.'*(-[O12121]-[O21211]-eps3.*eye(14))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=8
                                ...
                                %1221結束
                                SOS10=s3.'*(-[O21121]-[O12211]-eps3.*eye(14))*s3;
                                % 宣告不等式矩陣
                            ...
                            for subblock=9
                                ...
                                %2211結束
                                SOS11=s3.'*(-[O22121]-[O11211]-eps3.*eye(14))*s3;
                                % 宣告不等式矩陣
                        ...
                        for block=7
                            if N==2
                                ...
                                for subblock=1
                                    ...
                                    Oa111=diff(P2,x2).*(A1(2,:)*x_h)+H12+H12.'-Aij_tear*X2-X2.'*Aij_tear+Sum;
                                ...
                                for subblock=3
                                    ...
                                    Ob111=diff(P2,x2).*(A1(2,:)*x_h)+H12+H12.'-Aij_tear*X2-X2.'*Aij_tear+Sum;
                                        ...
                                        if M12(1,1)~=0 || M12(1,2)~=0 || M12(1,3)~=0 ||M12(1,4)~=0 || M12(1,5)~=0 || M12(1,6)~=0 || M12(2,1)~=0 || M12(2,2)~=0 || M12(2,3)~=0 || M12(2,4)~=0 || M12(2,5)~=0 || M12(2,6)~=0
                                            if M22(1,1)~=0 || M22(1,2)~=0 || M22(1,3)~=0 ||M22(1,4)~=0 || M22(1,5)~=0 || M22(1,6)~=0 || M22(2,1)~=0 || M22(2,2)~=0 || M22(2,3)~=0 || M22(2,4)~=0 || M22(2,5)~=0 || M22(2,6)~=0
                                                ...
                                                if eig_P1(1,1)>0 && eig_P1(2,1)>0 && eig_P1(3,1)>0 && eig_Q1(1,1)>0 && eig_Q1(2,1)>0 && eig_Q1(3,1)>0
                                                    ...
                                                    %K12,K22存在矩陣中
                                                    fin_K2_data(count_1*2-1,1)=F12(1,1);    fin_K2_data(count_1*2,1)=F12(2,1);
                                                    fin_K2_data(count_1*2-1,2)=F12(1,2);    fin_K2_data(count_1*2,2)=F12(2,2);
                                                    fin_K2_data(count_1*2-1,3)=F12(1,3);    fin_K2_data(count_1*2,3)=F12(2,3);
                                                    fin_K2_data(count_1*2-1,4)=F12(1,4);    fin_K2_data(count_1*2,1)=F12(2,4);
                                                    fin_K2_data(count_1*2-1,5)=F12(1,5);    fin_K2_data(count_1*2,2)=F12(2,5);
                                                    fin_K2_data(count_1*2-1,6)=F12(1,6);    fin_K2_data(count_1*2,3)=F12(2,6);
                                                    fin_K2_data(count_1*2-1,7)=F22(1,1);    fin_K2_data(count_1*2,7)=F22(2,1);
                                                    fin_K2_data(count_1*2-1,8)=F22(1,2);    fin_K2_data(count_1*2,8)=F22(2,2);
                                                    fin_K2_data(count_1*2-1,9)=F22(1,3);    fin_K2_data(count_1*2,9)=F22(2,3);
                                                    fin_K2_data(count_1*2-1,10)=F22(1,4);   fin_K2_data(count_1*2,10)=F22(2,4);
                                                    fin_K2_data(count_1*2-1,11)=F22(1,5);   fin_K2_data(count_1*2,11)=F22(2,5);
                                                    fin_K2_data(count_1*2-1,12)=F22(1,6);   fin_K2_data(count_1*2,12)=F22(2,6);
